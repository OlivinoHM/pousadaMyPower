...
del.Source = "SELECT *  FROM eventos  WHERE id = " + Replace(del__MMColParam, "'", "''") + ""
del.CursorType = 0
...
Command1.CommandText = "DELETE FROM eventos WHERE id = '" + Replace(Command1__id1, "'", "''") + "'"
Command1.CommandType = 1
Command1.CommandTimeout = 0
Command1.Prepared = true
Command1.Execute()
Response.redirect "listar_eventos.asp"
