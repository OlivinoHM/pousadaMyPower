...
Recordset1.Source = "SELECT *  FROM lazer  WHERE id = " + Replace(Recordset1__MMColParam, "'", "''") + ""
...
<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" class="">
 ...
 <div> 
<br>
<strong class="text-primary fa-2x azul">  &Xi; Editar Foto lazer</strong><br>
<br>
							...
							<tr>
								...
								<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
									...
									<tr>
										...
										<td width="306">
												<img src="<%=(Recordset1.Fields.Item("img").Value)%>" name=img width="272" height="197"></td>
										<td width="192">
												...
												<table border="0" style="border-collapse: collapse" width="100%" cellspacing="1" cellpadding="0" bgcolor="#000000">
													<tr>
														<td width="12">
														<a href="javascript:MM_openBrWindow('listar_lazer.asp?id=33&amp;id1=9','','width=815,height=400,scrollbars=yes')">
												...
												<a onClick="window.open('imglazer.asp?img=des01&id=1','Janela','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=400,height=190'); return false;" href="#">
												<font color="#FFFFFF">
