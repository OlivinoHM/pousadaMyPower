...
Recordset1.Source = "SELECT * FROM lazer ORDER BY titulo asc"
...
<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" class="">
 ...
 <div> 
<br>
<strong class="text-primary fa-2x azul">  &Xi; Listar Lazer</strong>
<strong class="text-primary fa-2x right">  <a href="incluir_lazer.asp" class="verde">   &Xi; Incluir Lazer</a></strong>
...
%>
                          ...
                          <div class="cantoredondo">
                            <table border="0" style="border-collapse: collapse" width="100%" cellpadding="6">
                              <tr>
                                <td width="30" align="center"><a href="editar_fotolazer.asp?id3=<%=(Recordset1.Fields.Item("id").Value)%>&id=<%=request("id")%>&id1=<%=request("id1")%>">Clique para atualizar ou incluir a foto da capa.<img src="<%=(Recordset1.Fields.Item("img").Value)%>" name=img width="184" height="120"></a></td>
                                ...
                                <td width="49" align="center"><a href="fotoslazer.asp?id=<%=(Recordset1.Fields.Item("id").Value)%>"> <div class=" icon-foto font-m right pading-botao" style="display:block; float:right"></div></a></td>
                                <td width="49" align="center"><a href="editar_lazer.asp?id=<%=(Recordset1.Fields.Item("id").Value)%>"> <div class=" icon-tag font-m right pading-botao" style="display:block; float:right"></div></a></td>
                                <td width="30" align="center"><a onClick="javascript:if (!confirm('Voc&ecirc; tem certeza que deseja excluir?')){return false;}" href="del_lazer.asp?id=<%=(Recordset1.Fields.Item("id").Value)%>"> <div class=" icon-fechar font-m right pading-botao" style="display:block; float:right"></div></a></td>
