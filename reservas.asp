...
menu.Source = "SELECT * FROM pgpacotes order by pactitulo asc"
menu.CursorType = 0
...
<!-- inicio .slideshow item -->        
	...
	<h3 class="sombra"><%=(atualiza.Fields.Item("resumo1").Value)%></h3>  		
	</div>
	</li>
...
<!-- inicio .slideshow item -->        
	...
	<h3 class="sombra"><%=(atualiza.Fields.Item("resumo2").Value)%></h3>  		
	</div>
	</li>
...
<!-- inicio .slideshow item -->        
	...
	<h3 class="sombra"><%=(atualiza.Fields.Item("resumo3").Value)%></h3>  		
	</div>
	</li>
    <%	end if
...
<!--/HEADER-->
	...
	<div id="news-wrap">
		<section id="guests">
			...
			<h2>Confira <span>nossos</span> <span>Pacotes</span></h2>
			<hr>
			<ul class="guests-items">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
				    <td class="link style63"><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="link">
			        <p class="pre-title">
				        <% 
				      ...
				      <table width="100%" border="0" cellspacing="0" cellpadding="0">
				        <tr>
				          <td><div align="left">
				            <table width="100%" border="0" cellspacing="0" cellpadding="0">
				              <tr>
				                <td class="link style63"><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="link">
				                  <p class="pre-title"><img src="<%=(menu.Fields.Item("img").Value)%>" width="366" height="267" border="0" class="borda" /><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="link"></p></td>
			                  </tr>
			                </table>
				            </div></td>
			            </tr>
                        ...
                        <tr>
				          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
				            <tr>
				              <td class="link style63"><p class="pre-title"><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="subtitle" style="color:#666; font-size:15px" ><%=(menu.Fields.Item("pactitulo").Value)%></a></p></td>
			                </tr>
				            </table></td>
			            </tr>
                        <tr>
				          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
				            <tr>
				              <td class="link style63"><p class="pre-title">----</p></td>
			                </tr>
				            </table></td>
			            </tr>
                        <tr>
				          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
				            <tr>
				              <td class=""><center><pmdh class=""><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="" style="color:#666; font-size:15px" >Op&ccedil;&atilde;o 1 - Entrada: <%=(menu.Fields.Item("datad1").Value)%></a><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="" style="color:#666; font-size:15px" > &agrave;s: <%=(menu.Fields.Item("horad1").Value)%></a><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="" style="color:#666; font-size:15px" > - Sa&iacute;da: <%=(menu.Fields.Item("dataa1").Value)%></a><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="" style="color:#666; font-size:15px" > &agrave;s: <%=(menu.Fields.Item("horaa1").Value)%></a></pmdh></center></td>
			                </tr>
				            </table></td>
			            </tr>
                        <tr>
				          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
				            <tr>
				              <td class=""><center><pmdh class=""><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="" style="color:#666; font-size:15px" >Op&ccedil;&atilde;o 2 - Entrada: <%=(menu.Fields.Item("datad2").Value)%></a><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="" style="color:#666; font-size:15px" > &agrave;s: <%=(menu.Fields.Item("horad2").Value)%></a><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="" style="color:#666; font-size:15px" > - Sa&iacute;da: <%=(menu.Fields.Item("dataa2").Value)%></a><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="" style="color:#666; font-size:15px" > &agrave;s: <%=(menu.Fields.Item("horaa2").Value)%></a></pmdh></center></td>
			                </tr>
				            </table></td>
			            </tr>
                        <tr>
				          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
				            <tr>
				              <td class=""><center><pmdh class=""><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="" style="color:#666; font-size:15px" >Op&ccedil;&atilde;o 3 - Entrada: <%=(menu.Fields.Item("datad3").Value)%></a><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="" style="color:#666; font-size:15px" > &agrave;s: <%=(menu.Fields.Item("horad3").Value)%></a><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="" style="color:#666; font-size:15px" > - Sa&iacute;da: <%=(menu.Fields.Item("dataa3").Value)%></a><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="" style="color:#666; font-size:15px" > &agrave;s: <%=(menu.Fields.Item("horaa3").Value)%></a></pmdh></center></td>
			                </tr>
				            </table></td>
			            </tr>
                        <tr>
                        ...
                        <tr>
				          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
				            <tr>
				              <td class=""><center>
				                <pmdh class=""><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="" style="color:#666; font-size:15px" >Valores &agrave; partir de:</a><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="" style="color:#666; font-size:15px" > <%=(menu.Fields.Item("2psap").Value)%></a><a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="" style="color:#666; font-size:15px" > </a></pmdh>
				              </center></td>
			                </tr>
				            </table></td>
			            </tr>
                        ...
                        <tr>
                          <td class="link style63"><p class="pre-title">&nbsp;</p>
                          <p class="pre-title">..........................................</p>
                          <p class="pre-title">&nbsp;</p></td>
                        </tr>
			          </table>
                      
                      <a href="pacotes.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="link">				      </a></td><% 
