...
<FORM METHOD="POST" ENCTYPE="multipart/form-data" ACTION="outputFile2.asp?img=<%=request("img")%>" onsubmit="return ValidaPagina(this);" name="billform">
  <div align="center">
  <table width="417" border="0" height="127" cellspacing="0" cellpadding="4">
    <tr bgcolor="#E5E5E5"> 
      <td colspan="2" height="31" bgcolor="#333333"> 
        <div align="center"><b><font face="Arial" color="#FFFFFF">Inserir Foto</font></b></div>
      </td>
    </tr>
    <tr bgcolor="#A6D2FF"> 
