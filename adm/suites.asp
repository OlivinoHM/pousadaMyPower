	...
	<div id="news-wrap">
		<section id="guests">
			...
			<ul class="guests-items">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
				    <td class="link style63">
                    
                    <a href="produtos.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="link">
...
%>
                      ...
                      <a href="produtos.asp?categoria=<%=(menu.Fields.Item("id").Value)%>">
                      <a href="produtos.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="link">
                      
                      <a href="produtos.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" >
					  <%=(menu.Fields.Item("titulo").Value)%>
                      
			                
                            
                      
                      <a href="produtos.asp?categoria=<%=(menu.Fields.Item("id").Value)%>"> </a>
                      <% 
