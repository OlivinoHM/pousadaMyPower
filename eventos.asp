...
menu.Source = "SELECT * FROM eventos order by titulo asc"
menu.CursorType = 0
...
<!--/HEADER-->
	...
	<div id="news-wrap">
		<section id="guests">
			...
			<h2>Eventos <span>em</span> <span> Bertioga</span></h2>
			<hr>
			<ul class="guests-items">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
				    <td class="link style63"><a href="eventos1.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="link">
			        <p class="pre-title">
				        <% 
...
%>
				      ...
				      <table width="100%" border="0" cellspacing="0" cellpadding="0">
				        <tr>
				          <td><div align="left">
				            <table width="100%" border="0" cellspacing="0" cellpadding="0">
				              <tr>
				                <td class="link style63"><a href="eventos1.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="link">
				                  <p class="pre-title"><img src="<%=(menu.Fields.Item("img").Value)%>" width="366" height="267" border="0" class="borda" /><a href="eventos1.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="link"></p></td>
			                  </tr>
			                </table>
				            </div></td>
			            </tr>
                        ...
                        <tr>
				          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
				            <tr>
				              <td class="link style63"><p class="pre-title"><a href="eventos1.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="subtitle" style="color:#666; font-size:15px" ><%=(menu.Fields.Item("titulo").Value)%></a></p></td>
			                </tr>
				            </table></td>
			            </tr>
                        <tr>
                      ...
                      <a href="eventos1.asp?categoria=<%=(menu.Fields.Item("id").Value)%>" class="link">				      </a></td><% 
