			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
			    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        <td class=""><center>
			          <pmdh class="">Op&ccedil;&atilde;o 1 - Entrada: <%=(categoria.Fields.Item("datad1").Value)%> &agrave;s: <%=(categoria.Fields.Item("horad1").Value)%> - Sa&iacute;da: <%=(categoria.Fields.Item("dataa1").Value)%> &agrave;s: <%=(categoria.Fields.Item("horaa1").Value)%></pmdh>
			          </center></td>
		          </tr>
			      </table></td>
		      </tr>
			  <tr>
			    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        <td class=""><center>
			          <pmdh class="">Op&ccedil;&atilde;o 2 - Entrada: <%=(categoria.Fields.Item("datad2").Value)%> &agrave;s: <%=(categoria.Fields.Item("horad2").Value)%> - Sa&iacute;da: <%=(categoria.Fields.Item("dataa2").Value)%> &agrave;s: <%=(categoria.Fields.Item("horaa2").Value)%></pmdh>
		            </center></td>
		          </tr>
			      </table></td>
		      </tr>
			  <tr>
			    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        <td class=""><center>
			          <pmdh class="">Op&ccedil;&atilde;o 3 - Entrada: <%=(categoria.Fields.Item("datad3").Value)%> &agrave;s: <%=(categoria.Fields.Item("horad3").Value)%> - Sa&iacute;da: <%=(categoria.Fields.Item("dataa3").Value)%> &agrave;s: <%=(categoria.Fields.Item("horaa3").Value)%></pmdh>
			          </center></td>
		          </tr>
			      </table></td>
		      </tr>
