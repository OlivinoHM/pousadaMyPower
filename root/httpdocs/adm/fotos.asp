...
Recordset1.Source = "SELECT *  FROM fotos where categoria='"&request("id")&"' ORDER BY id desc"
...
cat.Source = "SELECT *  FROM categoria  WHERE id = " + Replace(cat__MMColParam, "'", "''") + ""
cat.CursorType = 0
...
<br>
<br>
<strong class="text-primary fa-2x verde">  <a href="listar_categoria.asp" class="verde"> &lt;&lt; Voltar</a></strong>
<br>
<br>
                ...
                <table cellspacing="50" cellpadding="0" width="100%" align="center" border="0">
                  <tr>
                    <td><table border="0" style="border-collapse: collapse" width="579" cellpadding="0">
                      <tr>
                        <td width="579"><span style="text-transform: uppercase"><b><font face="Verdana"><font color="#DF8600"></font> <u class="botoes"> <a href="incluir_foto.asp?id=<%=request("id")%>&id1=<%=request("id1")%>&vsession=<%=request("id")%>"> <font color="#fffffff">INSERIR FOTO</font></a></u></font></b></span></td>
                      </tr>
                      <tr>
                        <td width="579">&nbsp;</td>
                      </tr>
...
%>
			...
			If pagina > 1 Then
				Response.Write "<a href=""fotos.asp?" & strProcura & "&pagina=1""><img src=""imagens/First.gif"" border=""0"" alt=""Primeira""></a>&nbsp;" & Chr(13)
				Response.Write "<a href=""fotos.asp?" & strProcura & "&pagina=" & (pagina - 1) & """><img src=""imagens/Previous.gif"" border=""0"" alt=""Anterior""></a>&nbsp;" & Chr(13)
			Else
			...
			If CInt(pagina) <> CInt(Recordset1.PageCount) Then 
				Response.Write "<a href=""fotos.asp?" & strProcura & "&pagina=" & (pagina + 1) & """><img src=""imagens/Next.gif"" border=""0"" alt=""Pr&oacute;xima""></a>&nbsp;" & Chr(13)
				Response.Write "<a href=""fotos.asp?" & strProcura & "&pagina=" & Recordset1.PageCount & """><img src=""imagens/Last.gif"" border=""0"" alt=""&Uacute;ltima""></a>&nbsp;" & Chr(13)
			Else
                      ...
                      <tr>
                        <td width="579"><table border="0" style="border-collapse: collapse" width="579" cellpadding="6">
                          <tr>
                            ...
                            <td width="47" align="center"><p><a href="editar_foto.asp?id3=<%=(Recordset1.Fields.Item("id").Value)%>&id=<%=request("id")%>&id1=<%=request("id1")%>"> <font color="#666666">Editar</font></a></p>
                              <p><a href="editar_foto.asp?id3=<%=(Recordset1.Fields.Item("id").Value)%>&id=<%=request("id")%>&id1=<%=request("id1")%>"><img src="editar.gif" width="32" height="31" border="0"></a></p></td>
                            <td width="61" align="center"><p><a onClick="javascript:if (!confirm('Voc&ecirc; tem certeza que deseja excluir?')){return false;}" href="del_foto.asp?del=<%=(Recordset1.Fields.Item("id").Value)%>&id=<%=request("id")%>&id1=<%=request("id1")%>"> <font color="#666666">Excluir</font></a></p>
                              <p><a onClick="javascript:if (!confirm('Voc&ecirc; tem certeza que deseja excluir?')){return false;}" href="del_foto.asp?del=<%=(Recordset1.Fields.Item("id").Value)%>&id=<%=request("id")%>&id1=<%=request("id1")%>"><img height="30" alt="del" src="excluir.gif" width="30" border="0"></a></p></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
