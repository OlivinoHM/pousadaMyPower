...
Recordset1.Source = "SELECT *  FROM pgpacotes  WHERE id = " + Replace(Recordset1__MMColParam, "'", "''") + ""
...
<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" class="">
 ...
 <div> 
<br>
<strong class="text-primary fa-2x azul">  &Xi; Editar foto pacotes</strong><br>
<br>
							...
							<tr>
								...
								<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
									...
									<tr>
										...
										<td width="257">
												<img src="<%=(Recordset1.Fields.Item("img").Value)%>" name=img width="274" height="190"></td>
										<td width="201">
												...
												<a onClick="window.open('imgpac.asp?img=des01&id=1','Janela','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=400,height=190'); return false;" href="#">
												<font color="#FFFFFF">
