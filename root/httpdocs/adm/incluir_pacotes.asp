...
If (CStr(Request("MM_insert")) = "form1") Then
  ...
  MM_fieldsStr  = "pactitulo|value|datad1|value|horad1|value|dataa1|value|horaa1|value|datad2|value|horad2|value|dataa2|value|horaa2|value|datad3|value|horad3|value|dataa3|value|horaa3|value|2psa|value|2psap|value|2pca|value|2pcap|value|3psa|value|3psap|value|3pca|value|3pcap|value|4psa|value|4psap|value|4pca|value|4pcap|value|6pca|value|6pcap|value|10pca|value|10pcap|value|16pca|value|16pcap|value|promocao1|value|promocaop1|value|promocao2|value|promocaop2|value|obs1|value"
  MM_columnsStr = "pactitulo|',none,''|datad1|',none,''|horad1|',none,''|dataa1|',none,''|horaa1|',none,''|datad2|',none,''|horad2|',none,''|dataa2|',none,''|horaa2|',none,''|datad3|',none,''|horad3|',none,''|dataa3|',none,''|horaa3|',none,''|2psa|',none,''|2psap|',none,''|2pca|',none,''|2pcap|',none,''|3psa|',none,''|3psap|',none,''|3pca|',none,''|3pcap|',none,''|4psa|',none,''|4psap|',none,''|4pca|',none,''|4pcap|',none,''|6pca|',none,''|6pcap|',none,''|10pca|',none,''|10pcap|',none,''|16pca|',none,''|16pcap|',none,''|promocao1|',none,''|promocaop1|',none,''|promocao2|',none,''|promocaop2|',none,''|obs1|',none,''"
...
<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" class="">
 ...
 <div> 
<br>
<strong class="text-primary fa-2x azul">  &Xi; Incluir Pacotes</strong>
<strong class="text-primary fa-2x right"></strong><br>
<br>
...
<tr>
            ...
            <tr>
                  <td width="579" colspan="4"><center><center><input name="pactitulo" type="text" size="30"></center></center></td>
            </tr>
     ...
     <table width="900" border="0" cellpadding="0" cellspacing="3" align="center">
       ...
       <tr>
         ...
         <td><input name="datad1" type="text" width="200"></td>
         <td><input name="horad1" type="text"  width="200"></td>
         <td><input name="dataa1" type="text" width="200"></td>
         <td><input name="horaa1" type="text" width="200"></td>
       </tr>
       <tr>
         <td><center>OP&Ccedil;&Atilde;O 2</center></td>
         <td><input name="datad2" type="text" size="38"></td>
         <td><input name="horad2" type="text" size="38"></td>
         <td><input name="dataa2" type="text" size="38"></td>
         <td><input name="horaa2" type="text" size="38"></td>
       </tr>
       <tr>
         <td><center>OP&Ccedil;&Atilde;O 3</center></td>
         <td><input name="datad3" type="text" size="38"></td>
         <td><input name="horad3" type="text" size="38"></td>
         <td><input name="dataa3" type="text" size="38"></td>
         <td><input name="horaa3" type="text" size="38"></td>
       </tr>
       <tr>
         <td>&nbsp;</td>
         <td>&nbsp;</td>
     ...
     <table border="0" style="border-collapse: collapse" width="900" cellpadding="0">
			  ...
			  <tr>
                ...
                <tr>
                <td width="455"><center><input name="2psap" type="text" size="20"></center></td>
                <td width="455"><center>
                  <input name="2pcap" type="text" size="20">
                </center></td>
              </tr>
			...
			<tr>    <td width="455"><center>
			  <input name="3psap" type="text" size="20">
			</center></td>
			  <td width="455"><center>
			    <input name="3pcap" type="text" size="20">
			  </center></td>
			  </tr>
			...
			<tr>    <td width="455"><center>
			  <input name="4psap" type="text" size="20">
			</center></td>
			  <td width="455"><center>
			    <input name="4pcap" type="text" size="20">
			  </center></td>
			  </tr>
			 <tr>
			    <td width="579"><p align="center">&nbsp; </td>
			...
			<tr>    <td width="455"><center><input name="6pcap" type="text" size="20"></center></td>
			  <td width="455"><center>
			    <input name="10pcap" type="text" size="20">
			    </center></td>
			  </tr>
		    </table>
			...
			<tr>    <td width="455"><center>
			  <table width="100%" border="0" cellpadding="0" cellspacing="0">
			    <tr>
			      <td width="35%">&nbsp;</td>
			      <td width="59%"><input name="16pcap" type="text" size="20"></td>
			      <td width="6%">&nbsp;</td>
			      </tr>
			    </table></center></td>
			...
			<tr>    <td width="455"><center><input name="promocao1" type="text" size="20"></center></td>
			  <td width="455"><center>
			    <input name="promocaop1" type="text" size="20">
			    </center></td>
			  </tr>
               <tr>
			    <td width="579"><p align="center">&nbsp; </td>
			...
			<tr>    <td width="455"><center><input name="promocao2" type="text" size="20"></center></td>
			  <td width="455"><center>
			    <input name="promocaop2" type="text" size="20">
			    </center></td>
			  </tr>
		    </table>
            <table border="0" style="border-collapse: collapse" width="900" cellpadding="0" align="center">
			  ...
			  <tr>
			    <td width="579" colspan="4"><center>
			        Obrseva��es do pacote:
			    </center></td>
			  <tr>
			    <td width="579" colspan="4"><center>
		        <textarea name="obs1" cols="50" rows="5" class="input" id="horad" style="width:550px;"></textarea></center></td>
              <tr>
                  <td width="579" colspan="4"><center>&nbsp;</center></td>
              <tr>
                  <td width="579" colspan="4"><center>&nbsp;</center></td>
