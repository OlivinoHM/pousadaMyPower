...
Recordset1.Source = "SELECT * FROM categoria ORDER BY img asc"
...
<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" class="">
 ...
 <div> 
<br>
<strong class="text-primary fa-2x azul">  &Xi; Incluir foto capa categoria</strong><br>
<br>
...
<form method="POST" action="<%=MM_editAction%>" name="form1">
	...
	<table height="27%" cellSpacing="0" cellPadding="0" width="100%" border="0">
		<tr>
			...
			<table cellSpacing="0" cellPadding="0" width="100%" align="center" bgColor="#ffffff" background="" border="0">
				<tr>
					<td width="100%">
					<div align="center">
						<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
                            ...
                            <input type="hidden" name="categoria" size="10" value="<%=request("id")%>">
										...
										<td width="216">
												<img src="<%=(Recordset1.Fields.Item("img").Value)%>" name=img width="200" height="150"></td>
										<td width="252">
