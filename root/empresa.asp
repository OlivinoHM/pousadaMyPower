...
<!--/HEADER-->
	...
	<div id="news-wrap">
		<section id="guests">
			<p class="pre-title">Um pouco mais sobre nós</p>
			<h2><span></span> <span>A <%=(atualiza1.Fields.Item("nomeempresa").Value)%></span></h2>
			<hr>
  ...
  <tr>
    <td align="left"> <table width="100" border="0" cellspacing="10" style="float:left;">
      <tr>
        <td><img src="<%=(atualiza1.Fields.Item("img1").Value)%>" border="0" style="   height:300px; border-radius:10px ;  padding-right:20px 20px 20px 20px;"/></td>
      </tr>
    </table>
      <%=(atualiza1.Fields.Item("sobreempresa").Value)%></td>
    </tr>
  <tr>
    <td align="left"></td>
    </tr>
...
<table width="100%" border="0" cellspacing="10">
  <tr>
    <td align="left"> <table width="100%" border="0" cellspacing="10" style="float:left;">
      <tr>
        <td width="310"><p class="pre-title">Veja o video de apresenta&Ccedil;&Atilde;o.</p></td>
      </tr>
    </table></td>
    </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="10">
  <tr>
    <td align="left"> <table width="100%" border="0" cellspacing="10" style="float:left;">
      <tr>
        <td width="310">
        <center><iframe width="700" height="500" src="https://www.youtube.com/embed/0i5JxmxcxxM" frameborder="0" allowfullscreen></iframe>>
</object>
</video></center>
