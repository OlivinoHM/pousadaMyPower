...
If (CStr(Request("MM_update")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editTable = "fotoslazer"
  MM_editColumn = "id"
  MM_recordId = "" + Request.Form("MM_recordId") + ""
  MM_editRedirectUrl = "fotoslazer.asp"
...
Recordset1.Source = "SELECT *  FROM fotoslazer  WHERE id = " + Replace(Recordset1__MMColParam, "'", "''") + ""
...
<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" class="">
 ...
 <div class="logo-box">	<img src="images/logo.png" alt="logo" width="132" height="205" id="logo-image"> </div>
				...
				<i class="buton font-p"> &nbsp;&nbsp;&nbsp; Em caso de d&Atilde;&ordm;vidas, entre em contato com o Suporte clicando no bot&Atilde;&pound;o SUPORTE SITE<span class="  font-m" ><strong></strong></span></i></div>
				<!-- /Navigation Menu -->
							...
							<tr>
								...
								<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
									...
									<tr>
										...
										<p align="right">Descri&ccedil;&atilde;o:&nbsp;&nbsp; </td>
										<td height="25" colspan="3"><textarea name="codigo" cols="12" rows="6"><%=(Recordset1.Fields.Item("codigo").Value)%></textarea></td>
									</tr>
									<tr>
										<td colspan="4">&nbsp;</td>
									</tr>
