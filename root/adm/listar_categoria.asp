...
Recordset1.Source = "SELECT *  FROM categoria ORDER BY id desc"
...
<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" class="">
 ...
 <div> 
<br>
<strong class="text-primary fa-2x azul">  &Xi; Listar su&iacute;tes</strong>
<strong class="text-primary fa-2x right">  <a href="incluir_categoria.asp" class="verde">   &Xi; Incluir su&iacute;tes&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; </a></strong><br>
<br>
...
%>
                          ...
                          <div class="cantoredondo">
                            <table border="0" style="border-collapse: collapse" width="100%" cellpadding="6">
                              <tr>
                                <td width="30" align="center"><a href="editar_fotocat.asp?id3=<%=(Recordset1.Fields.Item("id").Value)%>&id=<%=request("id")%>&id1=<%=request("id1")%>">Clique para atualizar ou incluir a foto da capa.<img src="<%=(Recordset1.Fields.Item("img").Value)%>" name=img width="184" height="120"></a></td>
                                <td width="611"><b><font color="#868686"></font></b>
                                  <table width="100%" height="130" border="0" cellpadding="0" cellspacing="2">
                                    ...
                                    <tr>
                                      <td><b>Resumo: <%=(Recordset1.Fields.Item("resumo").Value)%></b></td>
                                    </tr>
                                  </table></td>
                                <td width="49" align="center"><a href="fotos.asp?id=<%=(Recordset1.Fields.Item("id").Value)%>"> <div class=" icon-foto font-m right pading-botao" style="display:block; float:right"></div></a></td>
                                <td width="49" align="center"><a href="editar_categoria.asp?id=<%=(Recordset1.Fields.Item("id").Value)%>"> <div class=" icon-tag font-m right pading-botao" style="display:block; float:right"></div></a></td>
                                <td width="30" align="center"><a onClick="javascript:if (!confirm('Voc&ecirc; tem certeza que deseja excluir?')){return false;}" href="del_categoria.asp?id=<%=(Recordset1.Fields.Item("id").Value)%>"> <div class=" icon-fechar font-m right pading-botao" style="display:block; float:right"></div></a></td>
