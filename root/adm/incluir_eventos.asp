...
cat3.Source = "SELECT *  FROM lazer ORDER BY nome ASC"
cat3.CursorType = 0
	...
	<input type="hidden" name="img5" size="19"><input type="hidden" name="img4" size="19"><input type="hidden" name="img3" size="19"><input type="hidden" name="img2" size="19"><input type="hidden" name="img1" size="19">
												...
												<table border="0" style="border-collapse: collapse" width="90%" cellpadding="0">
                                                  ...
                                                  <tr>
												    ...
												    <td width="455"><select size="1" name="link4">
                                                            <%
While (NOT cat3.EOF)
%>
                                                            <option value="<%=(cat3.Fields.Item("id").Value)%>" <%If (Not isNull((cat3.Fields.Item("titulo").Value))) Then If (CStr(cat3.Fields.Item("id").Value) = CStr((atualiza.Fields.Item("link4").Value))) Then Response.Write("selected=""selected""") : Response.Write("")%>>(Lazer)&nbsp;-&nbsp;<%=(cat3.Fields.Item("titulo").Value)%></option>
                                                            <%
  cat.MoveNext()
Wend
