...
If (CStr(Request("MM_update")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_fieldsStr  = "titulo|value|texto|value|resumo|value"
  MM_columnsStr = "titulo|',none,''|texto|',none,''|resumo|',none,''"
...
<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" class="">
 ...
 <div> 
<br>
<strong class="text-primary fa-2x azul">  &Xi; Editar Su&iacute;te</strong><br>
<br>
 ...
 <form method="POST" action="<%=MM_editAction%>" name="form1">
	...
	<input type="hidden" name="img5" size="19"><input type="hidden" name="img4" size="19"><input type="hidden" name="img3" size="19"><input type="hidden" name="img2" size="19"><input type="hidden" name="img1" size="19">
												...
												<table border="0" style="border-collapse: collapse" width="100%" cellpadding="0">
												  ...
												  <tr>
												    <td>Nome da Su&iacute;te: 
										            <br>
                                                    <textarea name="titulo" cols="38" rows="1"><%=(Recordset1.Fields.Item("titulo").Value)%></textarea></td>
											      </tr>
                                                  </tr>
												  <tr>
												    <td>Resumo da Su&iacute;te: 
										            <br>											          <textarea name="resumo" class="textoForm" id="texto_materia" rows="2" cols="20"><%=(Recordset1.Fields.Item("resumo").Value)%></textarea></td>
											      </tr>
                                                  <tr>
												    <td>Texto da Su&iacute;te: 
										            <br>											          <textarea name="texto" class="textoForm" id="texto_materia" rows="5" cols="20"><%=(Recordset1.Fields.Item("texto").Value)%></textarea></td>
											      </tr>
                                                  </tr>
												  <tr>
												    <td width="579">&nbsp;&nbsp;
												      <input type="submit" value="Gravar e Visualizar" name="B1" class="botaoverde"></td>
											      </tr>
												  <tr>
												    <td width="579">&nbsp;</td>
											      </tr>
