...
<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" class="">
 ...
 <div> 
<br>
<strong class="text-primary fa-2x azul">  &Xi; Inserir Su&iacute;tes</strong><br>
<br>
...
<br>
	...
	<input type="hidden" name="img5" size="19"><input type="hidden" name="img4" size="19"><input type="hidden" name="img3" size="19"><input type="hidden" name="img2" size="19"><input type="hidden" name="img1" size="19">
												...
												<table width="100%" border="0" cellpadding="0" style="border-collapse: collapse">
												  <tr>
												    <td>Nome da Su&iacute;te: <br>
												      <textarea name="titulo" cols="38" rows="1"></textarea></td>
											      </tr>
    </tr>
  
  <tr>
    <td>Resumo da Su&iacute;te: <br>
      <textarea name="resumo" class="textoForm" id="texto_materia" rows="2" cols="20"></textarea></td>
  </tr>
  <tr>
    <td>Texto da Su&iacute;te: <br>
      <textarea name="texto" class="textoForm" id="texto_materia" rows="5" cols="20"></textarea></td>
  </tr>
    </tr>
