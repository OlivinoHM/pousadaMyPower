...
Recordset1.Source = "SELECT * FROM pgpacotes ORDER BY pactitulo asc"
...
<strong class="text-primary fa-2x right">  <a href="incluir_pacotes.asp" class="verde">   &Xi; Incluir Pacotes</a></strong>&nbsp;&nbsp;
<strong class="text-primary fa-2x center">  <a href="edit_pacotes.asp" class="verde">   &Xi; Pacotes em destaque na Pagina Inicial</a></strong>
...
%>
                          ...
                          <div class="cantoredondo">
                            <table border="0" style="border-collapse: collapse" width="100%" cellpadding="6">
                              <tr>
                                <td width="30" align="center"><a href="editar_fotopac.asp?id3=<%=(Recordset1.Fields.Item("id").Value)%>&id=<%=request("id")%>&id1=<%=request("id1")%>">Clique para atualizar ou incluir a foto da capa.<img src="<%=(Recordset1.Fields.Item("img").Value)%>" name=img width="184" height="120"></a></td>
                                <td width="611"><b><font color="#868686"></font></b>
                                  <table width="100%" height="130" border="0" cellpadding="0" cellspacing="2">
                                    <tr>
                                      <td><b>Titulo: <%=(Recordset1.Fields.Item("pactitulo").Value)%></b></td>
                                    </tr>
                                  </table></td>
                                <td width="49" align="center">&nbsp;</td>
                                <td width="49" align="center"><a href="editar_pacotes.asp?id=<%=(Recordset1.Fields.Item("id").Value)%>"> <div class=" icon-tag font-m right pading-botao" style="display:block; float:right"></div></a></td>
                                <td width="30" align="center"><a onClick="javascript:if (!confirm('Voc&ecirc; tem certeza que deseja excluir?')){return false;}" href="del_pacotes.asp?id=<%=(Recordset1.Fields.Item("id").Value)%>"> <div class=" icon-fechar font-m right pading-botao" style="display:block; float:right"></div></a></td>
